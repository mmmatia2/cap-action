...
export const TEAM_SYNC_AUTH_ERROR_CODES = {
  editorAuthRequired: "EDITOR_AUTH_REQUIRED",
  editorAuthInvalid: "EDITOR_AUTH_INVALID",
  extensionAuthDeprecated: "EXTENSION_AUTH_DEPRECATED",
...
export const TEAM_SYNC_AUTH_OWNERS = {
  editor: "editor",
  extensionLegacy: "extension_legacy"
} as const;
